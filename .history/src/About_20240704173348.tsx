  ...
  return (
    <section id="about" className="bg-white p-8">
      ...
      <p className="text-lg mb-4">
        Como psicólogo recém formado, minha missão é plantar sementes de esperança e compreensão.< br/>Acredito que, através do acolhimento e da escuta, posso contribuir para um mundo mais empático e saudável
      </p>
      <p className="text-lg">
