...
export default function Hero() {
  ...
  return (
    ...
    <p className="text-lg mb-6">Fornecer serviços psicológicos profissionais para ajudá-lo a alcançar o bem-estar mentalProviding professional psychological services to help you achieve mental well-being.</p>
